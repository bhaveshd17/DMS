...
let profile_container_div = document.getElementById("profile-container-div");
let profile = document.getElementById("profile");
window.addEventListener("resize", function () {
  if (window.innerWidth < 991) {
    details_cards.classList.remove("w-75");
    profile.classList.remove("container");
    profile_container_div.style.position = null;
    profile_container_div.style.right = null;
    profile_container_div.style.width = null;
    document.getElementById("home-tab").innerHTML = "Personal";
    document.getElementById("edu-tab").innerHTML = "Education";
    document.getElementById("curr-edu-tab").innerHTML = "Current Education";
  } else {
    details_cards.classList.add("w-75");
    profile.classList.add("container");
    profile_container_div.style.position = "fixed";
    profile_container_div.style.right = "0";
    profile_container_div.style.width = "28%";
    document.getElementById("home-tab").innerHTML = "Personal Details";
    document.getElementById("edu-tab").innerHTML = "Education Details";
    document.getElementById("curr-edu-tab").innerHTML = "Current Education Details";
  }
});
if (window.innerWidth < 991) {
  details_cards.classList.remove("w-75");
