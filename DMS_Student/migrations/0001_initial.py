# Generated by Django 3.2.5 on 2021-12-08 12:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skills', models.TextField(max_length=500)),
                ('domain', models.CharField(choices=[('Automotive', 'Automotive'), ('Banking', 'Banking'), ('Design', 'Design'), ('EduTech', 'EduTech'), ('Electrical Manufacturing', 'Electrical Manufacturing'), ('Financial Services', 'Financial Services'), ('Health Care', 'Health Care'), ('Information Technology', 'Information Technology'), ('Logistics & Supply Chain', 'Logistics & Supply Chain'), ('Management Consulting', 'Management Consulting'), ('Manufacturing', 'Manufacturing'), ('Marketing & Advertising', 'Marketing & Advertising'), ('Media Production', 'Media Production'), ('Professional Services', 'Professional Services'), ('Retail', 'Retail'), ('Telecommunications', 'Telecommunications')], max_length=100)),
                ('about_comp', models.TextField(max_length=500)),
                ('about_work', models.TextField(max_length=500)),
                ...
                ('who_can_apply', models.TextField(blank=True, max_length=500, null=True)),
                ('perks', models.TextField(max_length=500)),
                ('additional', models.TextField(max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_of_graduation', models.IntegerField(db_index=True, null=True)),
